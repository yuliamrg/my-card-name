...
const data = {
  name: "Yuliam Rivera",
  nickname: "@yuliam",
  description: "Colombiano, actualmente viviendo en Cali, estudiante de <b> Desarrollo web </b> en Platzi, empresa dedicada a la educación online y un apasionado del aprendizaje en línea.",
  avatar: "...",
  social: [
    {
      name: "platzi",
      url: "https://www.instagram.com/soyyuliamr95/",
      username: "soyyuliamr95",
      color: "[#98CA3F]",
    ...
    {
      name: "Youtube",
      url: "https://www.youtube.com/channel/UC6N-q_NDoHUye543y299UUQ",
      username: "Yuliam Rivera",
      color: "[#FF0000]",
      path: "M23.498 6.186a3.016 3.016 0 0 0-2.122-2.136C19.505 3.545 12 3.545 12 3.545s-7.505 0-9.377.505A3.017 3.017 0 0 0 .502 6.186C0 8.07 0 12 0 12s0 3.93.502 5.814a3.016 3.016 0 0 0 2.122 2.136c1.871.505 9.376.505 9.376.505s7.505 0 9.377-.505a3.015 3.015 0 0 0 2.122-2.136C24 15.93 24 12 24 12s0-3.93-.502-5.814zM9.545 15.568V8.432L15.818 12l-6.273 3.568z",
    },
    {
      name: "Git Hub",
      url: "https://github.com/yuliamrg",
      username: "soyyuliamr95",
      color: "[#6e5494]",
    ...
    {
      name: "twitter",
      url: "https://twitter.com/mellamoyuliam",
      username: "mellamoyuliam",
      color: "blue-300",
      path: "M23.953 4.57a10 10 0 01-2.825.775 4.958 4.958 0 002.163-2.723c-.951.555-2.005.959-3.127 1.184a4.92 4.92 0 00-8.384 4.482C7.69 8.095 4.067 6.13 1.64 3.162a4.822 4.822 0 00-.666 2.475c0 1.71.87 3.213 2.188 4.096a4.904 4.904 0 01-2.228-.616v.06a4.923 4.923 0 003.946 4.827 4.996 4.996 0 01-2.212.085 4.936 4.936 0 004.604 3.417 9.867 9.867 0 01-6.102 2.105c-.39 0-.779-.023-1.17-.067a13.995 13.995 0 007.557 2.209c9.053 0 13.998-7.496 13.998-13.985 0-.21 0-.42-.015-.63A9.935 9.935 0 0024 4.59z",
    },
    {
      name: "linkedin",
      url: "https://www.linkedin.com/in/yuliam-rivera-467b05114/",
      username: "yuliam",
      color: "blue-500",
...
const main = () => {
  ...
  let socials = data?.social
    ?.map((social) => {
      return `
    <a href="${social.url}" target="_blank">
    <svg
      class="w-6 h-6 cursor-pointer text-gray-400 hover:text-${
        social.color
      } fill-current"
      viewBox="${social?.box || "0 0 24 24"}"
  ...
  $description.appendChild($social)
}
